...
export default function PassengerNoteBox() {
  return (
    <div className="max-w-6xl mx-auto mb-5 p-4 border border-black rounded-md bg-blue-500 gap-6 flex flex-col sm:flex-row items-center sm:items-start">
      ...
      <div className="flex flex-col justify-center gap-2 text-center sm:text-left">
        ...
        <a href="tel:+919840789844">
          <button className="mt-2 px-4 py-2 border border-blue-500 text-white rounded bg-black w-fit mx-auto sm:mx-0">
            Call to Confirm Your Tirupati Package
          </button>
        </a>
      </div>
