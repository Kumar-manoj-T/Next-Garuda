...
<div className="w-full max-w-4xl mb-0">
  <div className="flex gap-4">
    {/* Tirupati Package */}
    <label
      className={`flex-1 border border-gray-200 rounded-md rounded-b-none border-b-0  shadow-md bg-white font-light px-4 py-3 text-center cursor-pointer transition-colors duration-200 ease-in-out ${
    ...
    {/* Car Rental Package */}
    <label
      className={`flex-1 border border-gray-300 rounded-md shadow-md bg-white font-light px-4 py-3 text-center cursor-pointer transition-colors duration-200 ease-in-out ${
    ...
    >
      ...
      {/* Main Booking Form */}
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-4xl mt-0 w-full">
